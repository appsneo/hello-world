 ...
 *
 */
class RandomsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '乱数ID　(システム用)', 'autoIncrement' => true, 'precision' => null],
        'user_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'ユーザーID', 'precision' => null, 'autoIncrement' => null],
        'random' => ['type' => 'string', 'length' => 40, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => 'ランダム英数字', 'precision' => null, 'fixed' => null],
        'expiring_date' => ['type' => 'string', 'length' => 40, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '無効となる日付', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'expiring_date' => 'Lorem ipsum dolor sit amet',
            'created_user' => 'Lorem ipsum dolor ',
            'modified_user' => 'Lorem ipsum dolor ',
            'created' => '2016-08-28 07:19:53',
            'modified' => '2016-08-28 07:19:53'
        ],
    ];
}
