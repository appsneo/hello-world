...
class ProjectUsersFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'ID　(システム用)', 'autoIncrement' => true, 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-08-02 18:55:05',
            'modified' => '2016-08-02 18:55:05'
        ],
    ];
}
