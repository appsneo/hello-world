 ...
 *
 */
class HowsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'paging test ID　(システム用)', 'autoIncrement' => true, 'precision' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-07-29 21:07:19',
            'modified' => '2016-07-29 21:07:19'
        ],
    ];
}
