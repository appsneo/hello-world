...
class ClientsFixture extends TestFixture
{
    ...
    public $fields = [
        'id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'クライアントID　(システム用)', 'autoIncrement' => true, 'precision' => null],
        ...
        'name' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => 'クライアント名', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-07-24 02:08:01',
            'modified' => '2016-07-24 02:08:01'
        ],
    ];
}
