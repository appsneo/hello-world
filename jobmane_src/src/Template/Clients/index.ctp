...
<?php $this->assign('title', '取引先の 登録/編集 | 業務管理システム') ?>

<?php $this->start('meta') ?>
<meta name="description" content="取引先の 登録/編集 | 業務管理システム" />
<?php $this->end() ?>
...
<!--大枠-->
  <section id="body">
    ...
    <form id="form-post" class="form-post" name="form-post" action='/clients/add/<?= $company->id ?>' method='post'>
        ...
        <div class="repeater">
          <div class="material" data-repeater-list="group-a">
            ...
            <?php foreach ($clients as $client): ?>
              <div data-repeater-item>
                <input type="hidden" name="repeat_id" value="<?= $client->id ?>"/>
