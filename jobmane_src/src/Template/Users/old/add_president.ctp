...
<!--大枠-->
  <section id="body">
  <form id="form-post" class="form-post" name="form-post" action='/users/add_president/' method='post'>
        ...
        <h1>ユーザー管理 詳細</h1>
          ...
          <div class="inbox2">
            ...
            <div class="row clfx">
              ...
              <div class="left_box">
                <dl class="authority">
                  <dt>権限：</dt>
                  <dd>
                    <select id="changeSelect" class="authority_select" name="authority_select" onchange="entryChange();" size="1">
            ...
            <h2 class="designated_title">会社情報</h2>
              ...
              <input class="company_text" type="text" name="company_name" size="24" />
              ...
              <h3 class="sub_title">所定勤務時間<span class="required">必須</span></h3>
                ...
                <div class="inbox3">
                  ...
                  <ul class="time">
                    <li>
                      <select class="time_select" name="minute3" size="1">
                        <option value="-" selected="selected">-</option>
                        <option value="00">00</option>
                        <option value="10">10</option>
                        <option value="20">20</option>
              ...
              <div class="inbox3">
                <ul class="radio">
                  <li>
                    <label for="early_shift_allowance_on">有</label><input id="early_shift_allowance_on" type="radio" name="early_shift_allowance" value="有">
                  </li>
                  <li>
                    <label for="early_shift_allowance_off">無</label><input id="early_shift_allowance_off" type="radio" name="early_shift_allowance" value="無">
                  </li>
                </ul>
                  ...
                  <div class="hourly_pay">
                    <input class="hourly_pay js-characters-change" type="text" name="hourly_pay" size="24" pattern="\d*" />円 / 時間
              ...
              <div class="inbox3">
                <ul class="radio">
                  <li>
                    <label for="early_shift_allowance_on2">有</label><input id="early_shift_allowance_on2" type="radio" name="early_shift_allowance2" value="有">
                  </li>
                  <li>
                    <label for="early_shift_allowance_off2">無</label><input id="early_shift_allowance_off2" type="radio" name="early_shift_allowance2" value="無">
                  </li>
                </ul>
                  ...
                  <div class="hourly_pay">
                    <input class="hourly_pay js-characters-change" type="text" name="hourly_pay2" size="24" pattern="\d*" />円 / 時間
                    <span class="inline-block">(半角数字のみ ,カンマもなし)</span>
                  </div>
                ...
                <div class="inbox3">
                  ...
                  <div class="go_edit_btn">
                    <a href="/materials/index/">使用部材の編集</a>
                  </div>
               ...
               <h3 class="sub_title2">取引先</h3>
                ...
                <div class="inbox3">
                  ...
                  <div class="go_edit_btn">
                    <a href="/clients/indexs/">取引先の編集</a>
                  </div>
