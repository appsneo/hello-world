      ...
      <div class="inbox">
        <h1>ユーザー管理 詳細</h1>
          ...
          <div class="inbox2">
            ...
            <div id="avatar">
              <img id="preview-photo" class="main_img" width="120" src="../img/common/default_avatar.png" alt="preview" />
            </div>
            <div id="select-file">
              <input type="file" id="select-photo" class="file" name="icon" onchange="imgUpload(this)" />
            </div>
            ...
            <textarea class="text" name="capabilities" rows="2" cols="40"></textarea>

            <h2 class="any">安全講習受講履歴</h2>
            <textarea class="text" name="safety" rows="2" cols="40"></textarea>
