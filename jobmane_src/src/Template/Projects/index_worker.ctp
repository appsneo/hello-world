...
<?php $this->assign('title', 'プロジェクト一覧 | 業務管理システム'); ?>

<?php $this->start('meta'); ?>
<meta name="description" content="プロジェクト一覧 | 業務管理システム" />
<?php $this->end(); ?>
...
<?php if($auth['role'] == 'president'): ?>
          <li>
            <a href="/projects/index-projects" id="a_proj"><img src="/img/common/table_pict.png" alt="" width="30" />プロジェクト別表示</a>
          </li>
<?php endif; ?>
        </ul>
